class Question {
    ...
    display(){
    this.title.html("ASTRONOMY QUIZ");
    this.title.position(350,0);

    this.question.html("Who Described Tardigrade, Which Is Sent To Space Is-");
    this.question.position(100,30);
    this.option1.html("1: Johann August");
    this.option1.position(150,60);
    this.option2.html("2: Charles Bonnet");
    this.option2.position(150,100);
    this.option3.html("3: Gottfried Reinhold Treviranus");
    this.option3.position(150,140);
    this.option4.html("4: Robert Remak");
